                    ...
                    <table class="table">
                        ...
                        @foreach($order->items as $index => $item)
                            <tr>
                                ...
                                <td class="sku-price text-center vertical-middle">NT${{ $item->price }}</td>
                                <td class="sku-amount text-center vertical-middle">{{ $item->amount }}</td>
                                <td class="item-amount text-right vertical-middle">NT${{ number_format($item->price * $item->amount, 2, '.', '') }}</td>
                            </tr>
                        @endforeach
                    ...
                    <div class="order-bottom">
                        ...
                        <div class="order-summary text-right">
                            <div class="total-amount">
                                <span>訂單總價：</span>
                                <div class="value">NT${{ $order->total_amount }}</div>
                            </div>
                            <div>
                                <span>訂單狀態：</span>
                                <div class="value">
